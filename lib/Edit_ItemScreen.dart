...
class _EditItemscreenState extends State<EditItemscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    cubit.itemDateController.text=cubit.items[cubit.editwithsameFeatuares]['date']??"" ;
    cubit.itemNameController.text=cubit.items[cubit.editwithsameFeatuares]['title']??"" ;
    cubit.itemPriceController.text=cubit.items[cubit.editwithsameFeatuares]['price']?.toString()??"" ;
    return Scaffold(
